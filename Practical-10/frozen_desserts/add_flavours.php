...
<body>
	...
	<ul>
		...
		<li><a class="active" href="add_flavours.php">Add Flavour</a></li>
	...
	<div style="margin-left:25%; height:750px;">
		...
		<?php
			...
			<div class="basic_box" style="background-color: white;">
		  	<table>
				<tr>
					<th colspan="4"><p style="font-size: 32px; text-align: center;">Add Flavours</p></th>
				</tr>
				<tr>
					<th>Flavour</th>
					<th>Available</th>
			...
			<br><br><br>
			<form action="add_flavours0.php" method="post">
			<table>
				<tr>
				...
				<tr>
					<td style="text-align: left;">Enter number to add:</td>
					<td style="text-align: left;"><input type="number" min="0" name="noofflavours" id="rooms" required></td>
				</tr>
				<tr>
					<td colspan="2" align="center">
					<input align="center" type="submit" value="Submit" style="font-size: 24px">
					</td>
				</tr>
			</table>
			</form>
