...
<body>
	...
	<div style="margin-left:25%; height:1080px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			<table class="basic_box" style="background-color: white;">
				<tr>
					<td colspan="6"><p style="font-size: 32px; text-align: center;"><b>Booking History</b></p>
				</td>
				<tr>
					<th>Order ID</th>
					<th>Name</th>
			...
			<table class="basic_box" style="background-color: white;">
				<tr>
					...
					<td colspan="2">
						<form action="admin_order_history_specific.php" method="post">
							<input type="number" name="order_id">
					</td>
				</tr>
				<tr>
					<td colspan="2" align="center"><button type="submit" style="font-size: 24px;">View Details</button></td></form>	
				</tr>
			</table>
		</div>
	</body>
